				...
				return (
					<React.Fragment key={item.label}>
						<div className="flex flex-col items-center">
							<a
								href={itemPath}
								className={`text-lg lg:text-2xl text-[var(--foreground)] font-semibold font-[700] animate-press border-[var(--accent)] hover:border-b-2 ${isActive ? "text-accent" : "font-normal"}`}
							>
								{item.label}
							</a>
