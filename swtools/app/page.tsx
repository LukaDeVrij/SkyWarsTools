	...
	return (
		<div className="flex h-fit flex-col bg-main w-full rounded-xl">
			...
			<div className="w-full flex flex-col lg:flex-row items-center justify-between h-fit p-5 lg:p-8">
				<div className="flex flex-col gap-1 lg:gap-2 w-full lg:w-10/12">
			...
			<div className="rounded-lg px-4 lg:px-8 font-semibold flex flex-col lg:flex-row gap-2 lg:gap-2 mb-4 ">
				<Link
					href="/about"
					className="w-full lg:w-[50%] h-17 bg-content rounded-xl p-3 lg:text-lg flex-row gap-2 justify-between items-center flex animate-press border-2 border-[#ffffff22]"
				>
					<p className="w-[80%]">Confused? Read about all features here!</p>
					<CircleQuestionMark className="w-12 h-12"></CircleQuestionMark>
				</Link>

				<Link
					href="/patreon"
					className="w-full lg:w-[50%] h-17 bg-content rounded-xl p-3 lg:text-lg flex-row gap-2 justify-between items-center flex animate-press border-2 border-[#ffffff22] enchanted"
					target="_blank"
